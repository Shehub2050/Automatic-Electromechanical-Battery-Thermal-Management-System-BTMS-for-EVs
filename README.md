...
![PID Tuning Comparison](pid_tuning_comparison.png)
...
| :---: | :---: |
| ![Performance Summary Main](performance_summary_main.png) | ![Performance Summary PID](performance_summary_pid.png) |
...
├── code_snippet.png
├── matlab_simulation.m
├── performance_summary_main.png
├── performance_summary_pid.png
...
matlab_simulation.m
4.To run the PID tuning comparison script:
pid_tuning_comparison.m
